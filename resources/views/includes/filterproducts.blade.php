            ...
            <li data-color="{{ $product->category ? $product->category->name : 'General' }}">
                <div class="uk-card uk-card-hover uk-card-large uk">
                    ...
                    <div class="uk-card-footer">
                        ...
                        {{--                            Classic--}}
                        <input type="submit" name="action_button" id="action_button" class="action_button" data-id="{{ $valor = $product->id }}" data-toggle="modal" data-target="#ModalEditProduct" class="btn btn-primary btn-round" value="Add" />
                    </div>
                </div>
            </li>
        @endforeach
