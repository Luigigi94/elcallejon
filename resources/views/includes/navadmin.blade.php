    ...
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="../assets/img/sidebar-1.jpg">
      ...
      -->
        ...
        <div class="sidebar-wrapper">
            <div class="user">
                <div class="photo">
                    <img src="{{ asset('img/board/faces/avatar.jpg') }}" />
                </div>
                <div class="user-info">
                                            ...
                                            <div class="table-responsive table-sales">
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/US.png') }}"> </div>
                                                        </td>
                                                        <td>USA</td>
                                                        <td class="text-right">
                                                            2.920
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/DE.png') }}"> </div>
                                                        </td>
                                                        <td>Germany</td>
                                                        <td class="text-right">
                                                            1.300
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/AU.png') }}"> </div>
                                                        </td>
                                                        <td>Australia</td>
                                                        <td class="text-right">
                                                            760
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/GB.png') }}"> </div>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/RO.png') }}"> </div>
                                                        </td>
                                                        <td>Romania</td>
                                                        <td class="text-right">
                                                            600
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="flag">
                                                                <img src="{{ asset('img/board/flags/BR.png') }}"> </div>
                                                        </td>
                                                        <td>Brasil</td>
                                                        <td class="text-right">
                                                            550
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{ asset('img/board/card-2.jpg') }}">
                                    </a>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{ asset('img/board/card-3.jpg') }}">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="card-actions text-center">
                        ...
                        <div class="col-md-4">
                            <div class="card card-product">
                                <div class="card-header card-header-image" data-header-animation="true">
                                    <a href="#pablo">
                                        <img class="img" src="{{ asset('img/board/card-1.jpg') }}">
                                    </a>
                                </div>
                                <div class="card-body">
                                    <div class="card-actions text-center">
        ...
        <ul class="dropdown-menu">
            ...
            <li class="active">
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{ asset('/img/board/sidebar-1.jpg') }}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{ asset('/img/board/sidebar-2.jpg') }}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{ asset('/img/board/sidebar-3.jpg') }}" alt="">
                </a>
            </li>
            <li>
                <a class="img-holder switch-trigger" href="javascript:void(0)">
                    <img src="{{ asset('/img/board/sidebar-4.jpg') }}" alt="">
                </a>
            </li>
